...
from littlelitter.blueprints.auth import auth_bp
from littlelitter.blueprints.home import home_bp
from littlelitter.blueprints.todo import todo_bp
from littlelitter.extensions import db, login_manager, csrf, babel
